...
usage()
{
    echo "Usage: $0 CARRIER_VER ELA_VER DID_VER ETH_VER ARBITER_VER"
    ...
    echo "Examples:"
    echo
    echo "  $0 master master master master master"
    echo "  $0 release-v6.0.1 v0.7.0 v0.2.1 v0.1.3.2 v0.2.1"
    echo
}
